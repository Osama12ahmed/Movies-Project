...
export default function Details() {
  ...
  useEffect(() => {
    const fetchMovie = async () => {
      try {
        // نجيب التفاصيل والاعضاء في نفس الوقت
  ...
  return (
    ...
    <Bar/>
        ...
        <div className="detail-container animate-slide-up">
          ...
          <div className="info animate-slide-left">
            ...
            <div className="rate">
              ...
              <p className="rateNum">Rate : {movieInfo.rate}</p>
              <img src={star} alt="" className="star animate-pulse" />
            </div>
            <h2 className="genres">Genres</h2>
            <p className="classification">{movieInfo.genres.join(", ")}</p>
      ...
      <div className="custom-video-container">
        ...
        <DetailV id={id} apiKey={apiKey} movie={movie} />
      </div>
